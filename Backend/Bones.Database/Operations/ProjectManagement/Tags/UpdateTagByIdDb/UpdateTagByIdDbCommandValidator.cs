...
{
    public override Task<ValidationResult> ValidateAsync(ValidationContext<UpdateTagByIdDbCommand> context, CancellationToken cancellation = new CancellationToken())
    {
