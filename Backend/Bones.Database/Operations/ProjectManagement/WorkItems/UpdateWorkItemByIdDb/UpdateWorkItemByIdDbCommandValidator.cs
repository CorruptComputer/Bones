...
{
    public override Task<ValidationResult> ValidateAsync(ValidationContext<UpdateWorkItemByIdDbCommand> context, CancellationToken cancellation = new CancellationToken())
    {
