...
public sealed class QueueDeleteQueueByIdDbHandler(BonesDbContext dbContext, ISender sender) : IRequestHandler<QueueDeleteQueueByIdDbHandler.Command, CommandResponse>
{
    /// <summary>
