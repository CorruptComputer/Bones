...
/// <param name="RequestingUser">The user this request is for</param>
public sealed record AddConfirmationEmailToQueueDbCommand(string EmailTo, string ConfirmationLink, BonesUser RequestingUser) : IRequest<CommandResponse>;