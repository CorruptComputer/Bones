...
public class CreateItemLayout(ISender sender) : IRequestHandler<CreateItemLayout.Command, CommandResponse>
{
    ...
    public async Task<CommandResponse> Handle(Command request, CancellationToken cancellationToken)
    {
        ...
        CommandResponse createLayoutVersionResponse = await sender.Send(new CreateItemLayoutVersionDb.Command(createLayoutResponse.Ids[nameof(ItemLayout)], request.Name, request.LayoutUse, request.FieldVersions), cancellationToken);
