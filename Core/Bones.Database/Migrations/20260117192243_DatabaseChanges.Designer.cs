...
namespace Bones.Database.Migrations
{
    ...
    [Migration("20260117192243_DatabaseChanges")]
            ...
            modelBuilder.Entity("Bones.Database.DbSets.Items.ItemLayoutVersion", b =>
                {
                    ...
                    b.HasOne("Bones.Database.DbSets.Items.ItemLayout", null)
                        .WithMany("Versions")
                        .HasForeignKey("ItemLayoutId1");
            ...
            modelBuilder.Entity("Bones.Database.DbSets.Items.ItemVersion", b =>
                {
                    ...
                    b.HasOne("Bones.Database.DbSets.Items.Item", null)
                        .WithMany("Versions")
            ...
            modelBuilder.Entity("Bones.Database.DbSets.TaskManagement.TaskQueue", b =>
                {
                    ...
                    b.HasOne("Bones.Database.DbSets.ProjectManagement.Initiative", null)
                        .WithMany("Queues")
                        .HasForeignKey("InitiativeId1");
