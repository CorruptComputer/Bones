...
/// <inheritdoc />
public class SetupChangeEmailTestUserDb(UserManager<BonesUser> userManager, ISender sender) : IRequestHandler<SetupChangeEmailTestUserDb.Command, CommandResponse>
{
    /// <summary>
    ...
    public async Task<CommandResponse> Handle(Command request, CancellationToken cancellationToken)
    {
        ...
        {
            DisplayName = "Change Email Test User",
            UserName = DefaultValues.TestUsers.CHANGE_EMAIL_TEST_USER_EMAIL,
            Email = DefaultValues.TestUsers.CHANGE_EMAIL_TEST_USER_EMAIL,
            EmailConfirmed = true,
        ...
        BonesUser? testUser = await userManager.FindByEmailAsync(DefaultValues.TestUsers.CHANGE_EMAIL_TEST_USER_EMAIL);
        ...
        await sender.Send(new AddAccountAuditDb.Command(
            testUser,
            DbSets.Audits.AccountAudit.Actions.Create,
