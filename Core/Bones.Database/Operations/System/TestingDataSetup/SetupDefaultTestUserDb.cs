...
/// <inheritdoc />
public class SetupDefaultTestUserDb(UserManager<BonesUser> userManager, ISender sender) : IRequestHandler<SetupDefaultTestUserDb.Command, CommandResponse>
{
    /// <summary>
    ...
    public async Task<CommandResponse> Handle(Command request, CancellationToken cancellationToken)
    {
        BonesUser userToCreate = new()
        {
            ...
            UserName = DefaultValues.TestUsers.TEST_USER_EMAIL,
            Email = DefaultValues.TestUsers.TEST_USER_EMAIL,
            EmailConfirmed = true,
        ...
        BonesUser? testUser = await userManager.FindByEmailAsync(DefaultValues.TestUsers.TEST_USER_EMAIL);
