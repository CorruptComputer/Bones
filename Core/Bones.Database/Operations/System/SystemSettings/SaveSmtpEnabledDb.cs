...
/// <inheritdoc />
public class SaveSmtpEnabledDb(BonesDbContext dbContext) : IRequestHandler<SaveSmtpEnabledDb.Command, CommandResponse>
{
    /// <summary>
    ...
    public async Task<CommandResponse> Handle(Command request, CancellationToken cancellationToken)
    {
        ...
        if (enabledSetting == null)
        {
            ...
            {
                Setting = SystemSetting.SettingType.SmtpEnabled,
        ...
        SystemAudit enabledAudit = new()
        {
            ...
            SettingChanged = SystemSetting.SettingType.SmtpEnabled,
