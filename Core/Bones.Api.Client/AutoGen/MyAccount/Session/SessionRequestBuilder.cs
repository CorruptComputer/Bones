...
using System;
namespace Bones.Api.Client.AutoGen.MyAccount.Session
{
    /// <summary>
    ...
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Bones.Api.Client.AutoGen.MyAccount.Session.SessionRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SessionRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/MyAccount/session{?sessionId*}", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Bones.Api.Client.AutoGen.MyAccount.Session.SessionRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public SessionRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/MyAccount/session{?sessionId*}", rawUrl)
        {
        }
        /// <summary>
        ...
        public async Task<global::Bones.Api.Client.AutoGen.Models.GetOrCreateMySessionResponse?> GetAsync(Action<RequestConfiguration<global::Bones.Api.Client.AutoGen.MyAccount.Session.SessionRequestBuilder.SessionRequestBuilderGetQueryParameters>>? requestConfiguration = default, CancellationToken cancellationToken = default)
        {
        ...
        /// <param name="requestConfiguration">Configuration for the request such as headers, query parameters, and middleware options.</param>
        public RequestInformation ToGetRequestInformation(Action<RequestConfiguration<global::Bones.Api.Client.AutoGen.MyAccount.Session.SessionRequestBuilder.SessionRequestBuilderGetQueryParameters>>? requestConfiguration = default)
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Bones.Api.Client.AutoGen.MyAccount.Session.SessionRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Bones.Api.Client.AutoGen.MyAccount.Session.SessionRequestBuilder WithUrl(string rawUrl)
        {
