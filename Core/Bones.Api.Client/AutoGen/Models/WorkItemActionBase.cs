...
namespace Bones.Api.Client.AutoGen.Models
{
    ...
    public partial class WorkItemActionBase : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Bones.Api.Client.AutoGen.Models.WorkItemActionBase"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Bones.Api.Client.AutoGen.Models.WorkItemActionBase CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Bones.Api.Client.AutoGen.Models.WorkItemActionBase();
        }
        /// <summary>
