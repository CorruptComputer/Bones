...
namespace Bones.Api.Client.AutoGen.Models
{
    ...
    public partial class CreateTaskQueueInInitiativeRequest : IAdditionalDataHolder, IParsable
    {
        /// <summary>Stores additional data not described in the OpenAPI description found when deserializing. Can be used for serialization as well.</summary>
        public IDictionary<string, object> AdditionalData { get; set; } = default!;
        /// <summary>The ID of the initiative to create the queue in</summary>
        public Guid InitiativeId { get; set; } = default!;
        /// <summary>The name of the queue</summary>
        public string Name { get; set; } = default!;
        /// <summary>
        /// Instantiates a new <see cref="global::Bones.Api.Client.AutoGen.Models.CreateTaskQueueInInitiativeRequest"/> and sets the default values.
        /// </summary>
        public CreateTaskQueueInInitiativeRequest()
        {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Bones.Api.Client.AutoGen.Models.CreateTaskQueueInInitiativeRequest"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Bones.Api.Client.AutoGen.Models.CreateTaskQueueInInitiativeRequest CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            ArgumentNullException.ThrowIfNull(parseNode);
            return new global::Bones.Api.Client.AutoGen.Models.CreateTaskQueueInInitiativeRequest();
        }
        /// <summary>
