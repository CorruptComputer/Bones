...
namespace Bones.Api.Client.AutoGen.Models
{
    ...
    public partial class DashboardWorkItemModel : IParsable
    {
        /// <summary>The date and time the work item was added to the queue</summary>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Bones.Api.Client.AutoGen.Models.DashboardWorkItemModel"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Bones.Api.Client.AutoGen.Models.DashboardWorkItemModel CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Bones.Api.Client.AutoGen.Models.DashboardWorkItemModel();
        }
        /// <summary>
