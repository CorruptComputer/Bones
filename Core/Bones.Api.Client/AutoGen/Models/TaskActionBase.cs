...
namespace Bones.Api.Client.AutoGen.Models
{
    ...
    public partial class TaskActionBase : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Bones.Api.Client.AutoGen.Models.TaskActionBase"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Bones.Api.Client.AutoGen.Models.TaskActionBase CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            _ = parseNode ?? throw new ArgumentNullException(nameof(parseNode));
            return new global::Bones.Api.Client.AutoGen.Models.TaskActionBase();
        }
        /// <summary>
