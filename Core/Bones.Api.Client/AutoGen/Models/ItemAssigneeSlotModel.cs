...
namespace Bones.Api.Client.AutoGen.Models
{
    ...
    public partial class ItemAssigneeSlotModel : IParsable
    {
        ...
        /// </summary>
        /// <returns>A <see cref="global::Bones.Api.Client.AutoGen.Models.ItemAssigneeSlotModel"/></returns>
        ...
        public virtual IDictionary<string, Action<IParseNode>> GetFieldDeserializers()
        {
            return new Dictionary<string, Action<IParseNode>>
            {
                ...
                { "states", n => { States = n.GetCollectionOfPrimitiveValues<string>()?.AsList() ?? throw new NullReferenceException("Unexpected null value for non-nullable property: 'States'"); } },
            };
        }
        /// <summary>
