...
using System;
namespace Bones.Api.Client.AutoGen.Project.Item.Fields.Create
{
    /// <summary>
    /// Builds and executes requests for operations under \Project\{projectId}\fields\create
    /// </summary>
    [global::System.CodeDom.Compiler.GeneratedCode("ReQuesty", "0.0.1")]
    public partial class CreateRequestBuilder : BaseRequestBuilder
    {
        /// <summary>
        /// Instantiates a new <see cref="global::Bones.Api.Client.AutoGen.Project.Item.Fields.Create.CreateRequestBuilder"/> and sets the default values.
        /// </summary>
        /// <param name="pathParameters">Path parameters for the request</param>
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateRequestBuilder(Dictionary<string, object> pathParameters, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Project/{projectId}/fields/create", pathParameters)
        {
        }
        /// <summary>
        /// Instantiates a new <see cref="global::Bones.Api.Client.AutoGen.Project.Item.Fields.Create.CreateRequestBuilder"/> and sets the default values.
        ...
        /// <param name="requestAdapter">The request adapter to use to execute the requests.</param>
        public CreateRequestBuilder(string rawUrl, IRequestAdapter requestAdapter) : base(requestAdapter, "{+baseurl}/Project/{projectId}/fields/create", rawUrl)
        {
        }
        /// <summary>
        ...
        /// <param name="body">Request to create a new item field</param>
        ...
        /// </summary>
        /// <returns>A <see cref="global::Bones.Api.Client.AutoGen.Project.Item.Fields.Create.CreateRequestBuilder"/></returns>
        /// <param name="rawUrl">The raw URL to use for the request builder.</param>
        public global::Bones.Api.Client.AutoGen.Project.Item.Fields.Create.CreateRequestBuilder WithUrl(string rawUrl)
        {
            return new global::Bones.Api.Client.AutoGen.Project.Item.Fields.Create.CreateRequestBuilder(rawUrl, RequestAdapter);
        }
    }
}
#nullable restore
