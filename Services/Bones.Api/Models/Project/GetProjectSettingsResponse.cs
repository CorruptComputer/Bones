...
public record GetProjectSettingsResponse
{
    ...
    internal static GetProjectSettingsResponse FromInternal(Database.DbSets.Projects.Project project, List<ItemField> itemFields, List<ItemLayout> itemLayouts)
    {
