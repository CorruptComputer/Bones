...
/// </summary>
[JsonSerializable(typeof(CreateWorkItemAction))]
public sealed record class CreateWorkItemAction : WorkItemActionBase
{
    /// <summary>
    ...
    internal override async Task<IRequest<CommandResponse>> ToInternalAsync(BonesUser user, ISender sender)
    {
        ...
        return new CreateWorkItemInQueue.Command(WorkItemQueueId, layout.Id, layout.LatestVersion.Id, Title, fieldValues, ActionDateTime, user);
    }
