...
/// <summary>
///   Handles everything related to Users managing their own account
/// </summary>
...
/// </remarks>
public class MyAccountController(ISender sender) : AuthenticatedControllerBase(sender)
{
    /// <summary>
    ///   Returns a users own full profile info
    /// </summary>
    /// <returns><see cref="GetMyProfileResponse"/></returns>
    [HttpGet("profile", Name = "GetMyProfileAsync")]
    ...
    /// <returns></returns>
    [HttpGet("session", Name = "GetOrCreateMySessionAsync")]
    ...
    [HttpPut("profile", Name = "UpdateMyProfileAsync")]
    ...
    /// <param name="request">The request</param>
    /// <returns>true if successful, what went wrong otherwise</returns>
    [HttpPut("password", Name = "ChangeMyPasswordAsync")]
    [ProducesResponseType<bool>(StatusCodes.Status200OK)]
    [ProducesResponseType<ErrorResponse>(StatusCodes.Status400BadRequest)]
    ...
    /// <param name="request">The request</param>
    /// <returns>true if successful, what went wrong otherwise</returns>
    [HttpPut("email", Name = "ChangeMyEmailAsync")]
    [ProducesResponseType<bool>(StatusCodes.Status200OK)]
    [ProducesResponseType<ErrorResponse>(StatusCodes.Status400BadRequest)]
