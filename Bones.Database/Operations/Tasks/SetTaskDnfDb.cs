...
public record SetTaskDnfDbCommand(Guid TaskHistoryId) : IRequest<CommandResponse>;

internal class SetTaskDnfDbHandler(BonesDbContext dbContext) : IRequestHandler<SetTaskDnfDbCommand, CommandResponse>
{
    public async Task<CommandResponse> Handle(SetTaskDnfDbCommand request, CancellationToken cancellationToken)
    {
