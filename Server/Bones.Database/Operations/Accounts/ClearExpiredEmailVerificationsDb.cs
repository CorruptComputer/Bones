...
internal class ClearExpiredEmailVerificationsDbHandler(BonesDbContext dbContext)
    : IRequestHandler<ClearExpiredEmailVerificationsDbQuery, DbQueryResponse<int>>
{
    public async Task<DbQueryResponse<int>> Handle(ClearExpiredEmailVerificationsDbQuery request,
