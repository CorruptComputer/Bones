...
internal class GetAccountByIdDbHandler(BonesDbContext dbContext) : IRequestHandler<GetAccountByIdDbQuery, DbQueryResponse<Account>>
{
    public async Task<DbQueryResponse<Account>> Handle(GetAccountByIdDbQuery request, CancellationToken cancellationToken)
    {
